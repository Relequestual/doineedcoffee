jQuery(document).ready(function($){
	...
	$('#more').click(function(e){
		...
		if(reasons.length == reason_no){			
			...
			$("h1").after('<p class="thatsall">That\'s all we have right now. Got more? Why not <a href="https://github.com/Relequestual/doineedcoffee/" title="Fork us on Github">fork us on Github</a>? =]</p>');
